function _tide_item_context
    if set -q SSH_TTY
        ...
        set tide_tmp_user $USER
        if contains -- $USER samuel.gabel
            set tide_tmp_user sml
        end
        tide_context_color=$tide_context_color_default _tide_print_item context $tide_tmp_user'@'$hostname
    end
end
