function __fish_print_hostnames -d "Print a list of known hostnames"
    ...
    # Read hosts known via git repos
    set -l hiera_host_dirs /Users/samuel.gabel/Code/puppet4/hieradata/hosts/ /Users/samuel.gabel/Code/dev-hiera/hosts/
    for dir in $hiera_host_dirs
        if test -r $dir
          ls $dir | sed -e's/.yaml$//'
        end
    end
